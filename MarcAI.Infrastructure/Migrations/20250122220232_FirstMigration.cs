        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_attendances_customers_CostumerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_availablePeriods_schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_attendancesServices", x => new { x.AttendenceId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_attendancesServices_attendances_AttendanceId",
                        column: x => x.AttendanceId,
                        principalTable: "attendances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_attendancesServices_services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attendances_CostumerId",
                table: "attendances",
                column: "CostumerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attendancesServices_AttendanceId",
                table: "attendancesServices",
                column: "AttendanceId");

            migrationBuilder.CreateIndex(
                name: "IX_attendancesServices_ServiceId",
                table: "attendancesServices",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_availablePeriods_ScheduleId",
